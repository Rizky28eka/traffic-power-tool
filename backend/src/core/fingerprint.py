...
class BrowserFingerprint:
    ...
    MOBILE_FINGERPRINTS = {
        ...
        "Android": {
            "devices": [
                ...
                {
                    "name": "Xiaomi 13 Pro",
                    "user_agent": "Mozilla/5.0 (Linux; Android 13; 2210132C) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 Mobile Safari/537.36",
                    "viewport": {"width": 393, "height": 852},
                    "pixel_ratio": 3,
                },
                {
                    "name": "Oppo Find X5",
                    "user_agent": "Mozilla/5.0 (Linux; Android 12; CPH2307) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/123.0.0.0 Mobile Safari/537.36",
            ...
            "devices": [
                {
                    ...
                    "user_agent": "Mozilla/5.0 (Linux; Android 14; SM-X710) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/126.0.0.0 Safari/537.36",
    ...
    def _get_country_data(country: Optional[str] = None) -> Tuple[str, str]:
        ...
        if country and country in BrowserFingerprint.COUNTRY_DATA:
            ...
            countries, weights = zip(
                *[(k, v["weight"]) for k, v in BrowserFingerprint.COUNTRY_DATA.items()]
            )
    ...
    def _get_desktop(country: Optional[str] = None) -> dict:
        os_name, os_details = choice(
            list(BrowserFingerprint.DESKTOP_OS_FINGERPRINTS.items())
        )
